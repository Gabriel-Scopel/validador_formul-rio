<?php
//inicializando variáveis, pois elas só existirão após o envio do formulário
$erroNome ="";
$erroEmail ="";
$erroSenha ="";
$erroRepeteSenha ="";

    //Verifica se foi enviado no método post
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if (empty($_POST['repete_senha'])){
            ...
            if($repete_senha !== $senha){
                $erroRepeteSenha = "A senha deve ser igual a anterior";
            }
        }
    ...
    function limpaPost($valor){
        $valor = trim($valor); //retira os espaços em branco no inicio e no final de uma string
        $valor = stripslashes($valor); //retira as barras
        $valor = htmlspecialchars($valor); //retira tags do html para evitar código malicioso
        return $valor;
    }
?>
<!DOCTYPE html>
